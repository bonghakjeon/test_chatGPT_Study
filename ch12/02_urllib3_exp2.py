...
# 파이썬 파일 "02_urllib3_exp2.py" 터미널 실행 명령어
# python 02_urllib3_exp2.py

# 파이썬 파일 "02_urllib3_exp2.py" 실행시 
...
# HTTP - POST 방식 Request(요청)할 URL 주소가 담긴 변수 url
url = 'https://jsonplaceholder.typicode.com/posts'
data = {"title": "Created Post", "body": "Lorem ipsum", "userId": 5}

# HTTP POST 요청하여 정보가 담긴 변수(data)를 추가로 저장 
# http.request 함수 호출시 'POST', url, fields=data 3가지 인자 전달 
response = http.request('POST', url, fields=data) # HTTP Request(요청) - POST 방식
